                        ...
                        <div class="row g-1 justify-content-center align-items-center">
                            ...
                            <div class="col-lg-6 col-md-6 transport-item attraction-card">
                                <div class="service-item text-center px-2">
                                    ...
                                    <p class="mb-8">
                                    ആലപ്പുഴ ഭാഗത്ത് നിന്നും വരുന്നവർ വൈറ്റില മെട്രോ സ്റ്റേഷനിൽ നിന്നും കയറി പേട്ട മെട്രോ സ്റ്റേഷനിൽ ഇറങ്ങുക. 
                                    തൃശ്ശൂർ ഭാഗത്ത് നിന്നും വരുന്നവർ ആലുവ മെട്രോ സ്റ്റേഷനിൽ നിന്നോ, വൈറ്റില മെട്രോ സ്റ്റേഷനിൽ നിന്നോ കയറി, 
                                    പേട്ട മെട്രോ സ്റ്റേഷനിൽ ഇറങ്ങുക. കോട്ടയം ഭാഗത്തുനിന്ന് വരുന്നവർ തൃപ്പൂണിത്തുറ മെട്രോ സ്റ്റേഷനിൽ നിന്നും കയറി 
                                    aപേട്ട മെട്രോ സ്റ്റേഷനിൽ ഇറങ്ങുക. 
                                    </p>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 transport-item attraction-card">
        ...
        <div class="carousel-wrapper">
                ...
                <div class="carousel-slide">
                    <div class="slide-content">
                        <div class="slide-media">
                            <img src="/img/announcements/onam-ponnonam.png" alt="Onam Ponnonam">
                        </div>
                    </div>
                    <div class="slide-content">
                        <div class="slide-text">
                            ...
                            <p>
                                ...
                                🎯 57-ാം ദേശീയ സമ്മേളനത്തോട് അനുബന്ധിച്ച് നടത്തുന്ന മത്സരപരമ്പരയിലെ അടുത്ത മത്സരം ഇതാ.
                                നിങ്ങളുടെ വീട്ടിലെ ഓണാഘോഷത്തിന്റെ ചെറിയ ചെറിയ ഭാഗങ്ങൾ സംയോജിപ്പിച്ച് ഒരു വീഡിയോ തയ്യാറാക്കി അയക്കുക. 
                                ഓണാഘോഷത്തിന്റെ പ്രൗഢിയും, നമ്മുടെ സാംസ്കാരിക തനിമയും, ആചാരാനുഷ്ഠാനങ്ങളും, 
                                ആഘോഷങ്ങളും ഉൾക്കൊള്ളുന്നതായിരിക്കണം വീഡിയോ.
                            </p>
                            <div class="announcement-section">
                                <p class="malayalam-text mb-3">ഈ മത്സരത്തെപ്പറ്റി കൂടുതൽ അറിയുവാൻ</p>
                                <a href="/main/content/announcements/onam-ponnonam.html" class="announcement-link malayalam-text">
            ...
            <!-- Slide 11 -->
                <div class="carousel-slide">
                    <div class="slide-content">
                        <div class="slide-media">
                            <img src="/img/announcements/uniform.png" alt="uniform">
                        </div>
                    </div>
                    <div class="slide-content">
                        <div class="slide-text">
                            ...
                            <p>
                                ...
                                എല്ലാ അംഗങ്ങളും ഒരേ വേഷവിധാനത്തിൽ വരുവാൻ ഞങ്ങൾ ആഗ്രഹിക്കുന്നു.
                                <br /><br />
                                സമ്മേളനത്തിന്റെ രണ്ടാം ദിവസത്തേക്ക് നിങ്ങൾക്കു വേണ്ട ഷർട്ട് / സാരി ഞങ്ങൾ അറേഞ്ച് ചെയ്തു തരുന്നു.</b>
                                <br /><br />
                                🥻സാരി Rs.490/
                                👕ഷർട്ട് Rs.460/ 
                            </p>
                            <div class="announcement-section">
                                <p class="malayalam-text mb-3">നിങ്ങൾക്ക് വേണ്ട വസ്ത്രങ്ങൾ കുറഞ്ഞ വിലക്ക് എങ്ങനെ ഓർഡർ ചെയ്യണം എന്നറിയുവാൻ</p>
                                <a href="/main/content/announcements/uniform.html" class="announcement-link malayalam-text">
                                    ഇവിടെ ക്ലിക്ക് ചെയ്യുക
                                </a>
                            </div>
                        </div>
